...
class OALineBotRichmenu {
  ...
  public static function deleteRichmenu ($richmenuId) { return ($response = OALineBotRichmenu::HTTPClient ()->delete (LINEBot::DEFAULT_ENDPOINT_BASE . '/v2/bot/richmenu/' . $richmenuId)) && ($response->isSucceeded () || (($response = $response->getJSONDecodedBody ()) && isset ($response['details']) && !$response['details'])); }

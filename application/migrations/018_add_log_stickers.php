  ...
  public function up () {
    $this->db->query (
      "CREATE TABLE `log_stickers` (
        ...
        `package_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Package ID',
        `sticker_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Sticker ID',
